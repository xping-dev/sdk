...
namespace Xping.Sdk.Core.HttpClients;
...
public class WebApplicationHttpClientFactory(
    ...
    HttpClientFactoryOptions factoryConfiguration) : IHttpClientFactory
{
    ...
    private readonly HttpClientFactoryOptions _factoryConfiguration =
    ...
    protected virtual WebApplicationFactoryClientOptions CreateWebApplicationFactoryClientOptions()
    {
        return new WebApplicationFactoryClientOptions
        {
            ...
            HandleCookies = HttpClientFactoryOptions.HttpClientHandleCookies,
