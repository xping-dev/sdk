...
/// <summary>
/// Represents the configuration options for the BrowserClient, extending the HttpClientOptions class to include
/// browser-specific settings. This class provides properties to configure the browser type, locale, headless mode,
/// wait until state, and geolocation for web tests using the Playwright library.
/// </summary>
public class BrowserOptions : HttpClientOptions
{
    /// <summary>
    ...
    /// <code>
    /// browserClientOptions.BrowserType = BrowserType.Firefox;
    /// </code>
    /// </remarks>
    ...
    /// </remarks>
    public void SetGeolocation(Geolocation geolocation) => PropertyBag.Add(new("geolocation"), geolocation);
    ...
    {
        PropertyBag.TryGet<Geolocation>(new("geolocation"), out var geolocation);
        return geolocation;
    }
    ...
    {
        PropertyBag.Properties.Remove(new("geolocation"));
    }
}
