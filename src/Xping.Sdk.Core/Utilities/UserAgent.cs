...
namespace Xping.Sdk.Core.Utilities;

/// <summary>
/// Contains commonly used user agent strings for desktop and mobile browsers.
/// </summary>
/// <remarks>
/// The UserAgent class provides a convenient way to access predefined user agent strings that can be used to 
/// simulate different browsers in HTTP requests. This can be particularly useful when performing automated testing 
/// where mimicking a specific browser is required.
/// </remarks>
public static class UserAgent
{
    ...
    /// </summary>
    public const string ChromeDesktop =
